package com.maxsella.fatmuscle.view.widget;
...
//        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(View.MeasureSpec.getSize(i), ((int) (this.mBottomView.getMeasuredHeight() * 0.75f)) + this.mContentView.getMeasuredHeight() + getPaddingBottom() + getPaddingTop());
    }
