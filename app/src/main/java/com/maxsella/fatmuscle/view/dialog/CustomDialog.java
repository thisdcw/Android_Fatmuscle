package com.maxsella.fatmuscle.view.dialog;
        ...
        public CustomDialog create() {
            ...
            if (this.rightButtonText != null) {
                ...
                if (this.rightButtonClickListener != null) {
                    ((Button) inflate.findViewById(R.id.btn_right)).setOnClickListener(new View.OnClickListener() { // from class: com.marvoto.fat.dialog.CustomDialog.Builder.1
            ...
            if (this.leftButtonText != null) {
                ...
                if (this.leftButtonClickListener != null) {
                    ((Button) inflate.findViewById(R.id.btn_left)).setOnClickListener(new View.OnClickListener() { // from class: com.marvoto.fat.dialog.CustomDialog.Builder.2
                        @Override // android.view.View.OnClickListener
                        public void onClick(View view) {
            ...
            if (this.singleButtonText != null) {
                ...
                if (this.singleButtonClickListener != null) {
                    ((Button) inflate.findViewById(R.id.btn_single)).setOnClickListener(new View.OnClickListener() { // from class: com.marvoto.fat.dialog.CustomDialog.Builder.3
                        @Override // android.view.View.OnClickListener
                        public void onClick(View view) {
