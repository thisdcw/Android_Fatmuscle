...
public class MetricInchUnitUtil {
    ...
    public static final String getUnitStr(double d) {
        int i = SharedPreferencesUtil.getInt(MyApplication.getInstance(), Constant.CUR_UNIT, FatConfigManager.defaultUnit.value());
    ...
    public static final String getValueStr(int i) {
        int i2 = SharedPreferencesUtil.getInt(MyApplication.getInstance(), Constant.CUR_UNIT, FatConfigManager.defaultUnit.value());
        if (i2 == 1) {
